 ...
 * @author yogan
 */
public class lihat_stok extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(320, 190, 970, 500);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/stok.png"))); // NOI18N
        jPanel2.add(jLabel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lihat_stok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lihat_stok().setVisible(true);
            }
        });
    }
